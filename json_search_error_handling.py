...
def find_password():
    ...
    try:
        ...
        messagebox.showinfo(title='May error', message='No data/results found')
    else:
        if website in data:
            ...
            messagebox.showinfo(title='May error pa rin', message='Not found in the list. You have to double check or create website and password')
# ---------------------------- UI SETUP ------------------------------- #
bintana = Tk()
